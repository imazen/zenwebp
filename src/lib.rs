...
pub use decoder::{
    ...
    decode_argb, decode_argb_into, decode_bgr, decode_bgr_into, decode_bgra, decode_bgra_into,
    decode_rgb, decode_rgb_into, decode_rgba, decode_rgba_into, decode_yuv420,
};
