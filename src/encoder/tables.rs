//! VP8 encoding tables and constants.
//!
//! This module contains the large lookup tables used for VP8 encoding,
//! including entropy costs, quantizer tables, and mode costs.

// Allow unused items - these tables are part of the complete libwebp
...
//------------------------------------------------------------------------------
// Spectral distortion (TDisto) weights
...
//------------------------------------------------------------------------------
// Filter strength lookup table

/// Maximum delta size for filter strength lookup
pub(crate) const MAX_DELTA_SIZE: usize = 64;
...
#[rustfmt::skip]
pub(crate) const LEVELS_FROM_DELTA: [[u8; MAX_DELTA_SIZE]; 8] = [
