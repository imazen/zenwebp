# zenwebp ![CI](https://img.shields.io/github/actions/workflow/status/imazen/zenwebp/ci.yml?style=flat-square&label=CI) ![crates.io](https://img.shields.io/crates/v/zenwebp?style=flat-square) ![docs.rs](https://img.shields.io/docsrs/zenwebp?style=flat-square) ![MSRV](https://img.shields.io/badge/MSRV-1.89-blue?style=flat-square) ![license](https://img.shields.io/badge/License-AGPL%2FCommercial-blue?style=flat-square) ![codecov](https://img.shields.io/codecov/c/github/imazen/zenwebp?style=flat-square)
...
All unsafe code is generated by archmage for SIMD dispatch and is not user-written.
